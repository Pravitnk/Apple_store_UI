...
const Navbar = ({ handeNavClick, activePage, toggleNavbar, isNavbarOpen }) => {
  return (
    <>
      <div
        className={`2xl:w-80 xl:w-52 w-44 h-full bg-[#e9e4e4] flex flex-col justify-between pt-5 pl-6 pb-14 md:pb-0 absolute md:relative z-10 transition-transform duration-300 ${
      ...
      >
        ...
        <div className="flex justify-between pr-6 pb-2">
          ...
          <a href="#">
            <i className="bx bxl-twitter text-2xl text-blue-600"></i>
          </a>
          <a href="#">
            <i className="bx bxl-facebook text-2xl text-blue-600"></i>
          </a>
          <a href="#">
      ...
      <button
        className="fixed md:hidden bottom-4 left-4 p-2 text-4xl text-blue-400 z-20"
